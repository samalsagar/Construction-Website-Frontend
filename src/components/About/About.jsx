        ...
        <div className="grid grid-cols-4 sm:grid-cols-12 gap-6 px-4">
          <div className="col-span-4 sm:col-span-3">
            <div className="bg-white shadow rounded-lg p-6">
              <div className="flex flex-col items-center">
                <img src={ceoImg} className="w-32 h-32 bg-gray-300 rounded-full mb-4 shrink-0" >

                </img>
                <h1 className="text-xl font-bold">Rohan Mishra</h1>
                <p className="text-gray-700">CEO/FOUNDER</p>
                <p>+91- 6306206941</p>
              </div>
              <hr className="my-6 border-t border-gray-300" />
              <div className="flex flex-col">
                <span className="text-gray-700 uppercase font-bold tracking-wider mb-2">SERVICES</span>
                <ul>
                  <Link to="/services">
                    <li className="mb-2">Construction</li>
                  </Link>
                  <Link to="/services">
                    <li className="mb-2">Construction Planning</li>
                  </Link>
                  <Link to="/services">
                    <li className="mb-2">Renovation and Construction</li>
                  </Link>
          ...
          <div className="col-span-4 sm:col-span-9">
            <div className="bg-white shadow rounded-lg p-6">
              ...
              <p className="text-gray-700">YATHARTH ARCHITECT : Building Excellence Since 2018<br />
              ...
              <h2 className="text-xl font-bold mt-6 mb-4">Our Expertise</h2>
              <div className="mb-6">
                <p className="mt-2">
              ...
              <h2 className="text-xl font-bold mt-6 mb-4">Our Commitment</h2>
              <div className="mb-6">
                <p className="mt-2">
              ...
              <h2 className="text-xl font-bold mt-6 mb-4">Why Choose Us?</h2>
              <div className="mb-6">
                <p className="mt-2">
