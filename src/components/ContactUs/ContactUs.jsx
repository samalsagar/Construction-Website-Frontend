...
function ContactUs() {
    ...
    const postData = async () => {
        ...
        await fetch("http://localhost:8080/contact/save", requestOptions)
            .then((response) => {
    ...
    return (
        <div className="grid sm:grid-cols-2 items-start gap-16 p-4 mx-auto max-w-4xl bg-white font-[sans-serif] mt-10">
            ...
            <form className="ml-auto space-y-4 mb-10">
                ...
                <button type='button'
                    className="text-white bg-blue-500 hover:bg-blue-600 tracking-wide rounded-md text-sm px-4 py-3 w-full !mt-6" onClick={handleSend}>Send</button>
            </form>
        </div>
    )
}
