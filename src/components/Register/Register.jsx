    ...
    const postApi = async () => {
        ...
        try {
            ...
            if (response.ok) {
                ...
                setPopupMessage(JSON.parse(result).message);
                sendEmail();
                setname("");
                setemail('');
                setpassword('');
                ...
                <form className="md:col-span-2 w-full py-6 px-6 sm:px-16">
                    ...
                    <div className="space-y-6">
                        ...
                        <div>
                            ...
                            <div className="relative flex items-center">
                                <input
                                    name="number" type="number" required className="text-gray-800 bg-white border border-gray-300 w-full text-sm px-4 py-2.5 rounded-md outline-blue-500" placeholder="Enter number"
                                    value={number}
